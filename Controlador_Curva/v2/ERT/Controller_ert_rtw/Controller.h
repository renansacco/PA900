...
typedef struct {
  ...
  real32_T m_bpLambda_n3[3];           // '<S9>/1-D Lookup Table2'
  ...
  uint32_T m_bpIndex_a[4];             // '<S9>/1-D Lookup Table2'
  uint32_T m_Cache01_p;                // '<S9>/1-D Lookup Table2'
  uint32_T m_Cache02_d[2];             // '<S9>/1-D Lookup Table2'
  uint32_T m_Cache03_d;                // '<S9>/1-D Lookup Table2'
  uint32_T m_bpIndex_k;                // '<S9>/1-D Lookup Table3'
...
typedef struct {
  // Expression: Controlador.Curva.Gains
  //  Referenced by: '<S9>/1-D Lookup Table2'

  real32_T uDLookupTable2_tableData[48];
  ...
  // Expression: Controlador.Curva.T_look
  ...
  uint32_T uDLookupTable2_maxIndex[3];

  // Computed Parameter: uDLookupTable2_dimSizes
  //  Referenced by: '<S9>/1-D Lookup Table2'

  uint32_T uDLookupTable2_dimSizes[3];
