...
typedef struct {
  // ï¿½ngulo da trajetï¿½ria no ponto relevante, em rad
  real32_T alpha;

  // Erro lateral do veï¿½culo em relaï¿½ï¿½o ï¿½ trajetï¿½ria no ponto relevante, em metros 
  real32_T e;

  // Curvatura da trajetï¿½ria no ponto relevante, em 1/m
  real32_T curvature;

  // Erro angular em radianos (psiRef - psi)
  real32_T psiError;

  // Arclength acumulado ao longo do path [m]
  real32_T s;
...
#ifndef DEFINED_TYPEDEF_FOR_struct_fGArHSqYXWkzbT7iaoFQW_
#define DEFINED_TYPEDEF_FOR_struct_fGArHSqYXWkzbT7iaoFQW_
...
#ifndef DEFINED_TYPEDEF_FOR_struct_6o0ISBBNSXcI0DxNkZWKVD_
#define DEFINED_TYPEDEF_FOR_struct_6o0ISBBNSXcI0DxNkZWKVD_

typedef struct {
  real_T Ts;
  struct_fGArHSqYXWkzbT7iaoFQW Curva;
  struct_aZbHsNpZ2wOKlbf6Q3u2yD Keep;
  struct_K7aNpc71bVF4P6UKAeMFnB Entry;
} struct_6o0ISBBNSXcI0DxNkZWKVD;
