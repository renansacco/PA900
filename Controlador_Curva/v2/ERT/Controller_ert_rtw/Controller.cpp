...
// C/C++ source code generated on : Mon Jun 29 16:51:23 2026
//
...
real32_T look1_iflf_plinlcapw(real32_T u0, const real32_T bp0[], const real32_T
...
real32_T intrp3d_fu32fla_pw(const uint32_T bpIndex[], const real32_T frac[],
  const real32_T table[], const uint32_T stride[], const uint32_T maxIndex[])
{
  real32_T y;
  uint32_T offset_2d;
...
void ControladorModelClass::step()
{
    ...
    if (guard1) {
      ...
      bpIndices[1U] = plook_u32u8f_lincpa
        (Controller_P.userParameters.straightAggressiveness,
         Controller_ConstP.pooled10, 6U, &rtb_Switch1,
         &Controller_DW.m_Cache02_j);
      fractions[1U] = rtb_Switch1;
      bpIndices[3U] = plook_u32u8f_lincpa(Controller_P.userParameters.modelPlant,
        Controller_ConstP.pooled11, 1U, &rtb_Switch1, &Controller_DW.m_Cache04_o);
      fractions[3U] = rtb_Switch1;
      bpIndices[2U] = plook_u32u8f_lincpa
        (Controller_ConstB.DataTypeConversion6_n[0], Controller_ConstP.pooled11,
      ...
      bpIndices[2U] = plook_u32u8f_lincpa
        (Controller_ConstB.DataTypeConversion6_n[1], Controller_ConstP.pooled11,
      ...
      //   SignalConversion generated from: '<Root>/Guidance'
      //   SignalConversion generated from: '<Root>/Measurements'
  ...
  if (rtb_controllerState == CONTROLLER_STATE_KEEP) {
    ...
    bpIndices_0[1U] = plook_u32u8f_lincpa
      (Controller_P.userParameters.straightAggressiveness,
       Controller_ConstP.pooled10, 6U, &rtb_Switch1, &Controller_DW.m_Cache02);
    ...
    rtb_uDLookupTable1_idx_0 = Controller_mod_d(Controller_U.Guidance.alpha);
    if (rtb_Switch1 > rtb_uDLookupTable1_idx_0) {
      if (std::abs((6.28318548F - rtb_Switch1) + rtb_uDLookupTable1_idx_0) < std::
          abs(rtb_uDLookupTable1_idx_0 - rtb_Switch1)) {
        Controller_B.psi_error_keep = (6.28318548F - rtb_Switch1) +
          rtb_uDLookupTable1_idx_0;
      } else {
        Controller_B.psi_error_keep = rtb_uDLookupTable1_idx_0 - rtb_Switch1;
      }
    } else if (rtb_Switch1 < rtb_uDLookupTable1_idx_0) {
      if (std::abs(rtb_Switch1 - rtb_uDLookupTable1_idx_0) < std::abs
          ((6.28318548F - rtb_uDLookupTable1_idx_0) + rtb_Switch1)) {
        Controller_B.psi_error_keep = rtb_uDLookupTable1_idx_0 - rtb_Switch1;
      } else {
    ...
    rtb_Switch1 = (rtb_uDLookupTable1_idx_1 * Controller_B.psi_error_keep +
  ...
  if (rtb_controllerState == CONTROLLER_STATE_CURVE) {
    ...
    bpIndices_1[0U] = plook_u32ff_lincpa(Controller_U.Measurements.vx,
      Controller_ConstP.pooled5, 7U, &rtb_Switch1, &Controller_DW.m_Cache01_p);
    fractions_1[0U] = rtb_Switch1;
    bpIndices_1[2U] = plook_u32ff_lincpa(static_cast<real32_T>
      (Controller_P.userParameters.curveAggressiveness),
      Controller_ConstP.pooled7, 2U, &rtb_Switch1, &Controller_DW.m_Cache03_d);
    fractions_1[2U] = rtb_Switch1;
    bpIndices_1[1U] = plook_u32ff_lincpa(1.0F, Controller_ConstP.pooled6, 1U,
      &rtb_Switch1, &Controller_DW.m_Cache02_d[0]);
    fractions_1[1U] = rtb_Switch1;

    // Lookup_n-D: '<S9>/1-D Lookup Table2'
    rtb_uDLookupTable1_idx_1 = intrp3d_fu32fla_pw(bpIndices_1, fractions_1,
      Controller_ConstP.uDLookupTable2_tableData,
      Controller_ConstP.uDLookupTable2_dimSizes,
      Controller_ConstP.uDLookupTable2_maxIndex);
    bpIndices_1[1U] = plook_u32ff_lincpa(2.0F, Controller_ConstP.pooled6, 1U,
      &rtb_Switch1, &Controller_DW.m_Cache02_d[1]);
    fractions_1[1U] = rtb_Switch1;

    // Lookup_n-D: '<S9>/1-D Lookup Table2'
    rtb_uDLookupTable_idx_1 = intrp3d_fu32fla_pw(bpIndices_1, fractions_1,
      Controller_ConstP.uDLookupTable2_tableData,
      Controller_ConstP.uDLookupTable2_dimSizes,
      Controller_ConstP.uDLookupTable2_maxIndex);
    ...
    rtb_Switch1 = look1_iflf_plinlcapw(static_cast<real32_T>
      (Controller_P.userParameters.curveAggressiveness),
      Controller_ConstP.pooled7, Controller_ConstP.uDLookupTable3_tableData,
      &Controller_DW.m_bpIndex_k, 2U);

    // Product: '<S9>/Product3' incorporates:
    //   Inport: '<Root>/Measurements'
    //   SignalConversion generated from: '<Root>/Measurements'

    rtb_Switch1 *= Controller_U.Measurements.vx;
    ...
    Controller_MATLABFunction1(Controller_U.Guidance.alpha + std::atan
      (-Controller_U.Guidance.e / rtb_Switch1),
    ...
    rtb_Switch1 = (Controller_B.r_ref - Controller_U.Measurements.r) *
      rtb_uDLookupTable_idx_1 + rtb_uDLookupTable1_idx_0 *
      rtb_uDLookupTable1_idx_1;
  ...
  if (Modo_Curva_prev || (!Controller_B.enable_control)) {
    ...
    Controller_Y.Controller_State.Angular_Speed_Target = 0.0F;
  } else {
    // BusCreator: '<Root>/Bus Creator' incorporates:
    //   Outport: '<Root>/Controller_State'
