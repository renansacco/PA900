...
controllerElement(1).Description = '�ngulo da trajet�ria no ponto relevante, em rad';
...
controllerElement(2).Description = 'Erro lateral do ve�culo em rela��o � trajet�ria no ponto relevante, em metros';
...
controllerElement(3).Description = 'Curvatura da trajet�ria no ponto relevante, em 1/m';
